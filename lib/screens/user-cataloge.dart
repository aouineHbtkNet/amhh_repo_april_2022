        ...
        builder: (context) {
          return AlertDialog(
            content: myString == null
                ...
                : ClipRect(child: Image.network('http://192.168.1.22/api_v_1/storage/app/public/notes/$myString'),),
            actions: [
    ...
    return Scaffold(
      body: list.isEmpty
          ...
          : SafeArea(
              child: Column(
                children: [
                  PopUpMenuWidget(putArrow: false, voidCallbackCart: () {Navigator.of(context).pushNamed(UserCart.id);},),
                  SizedBox(height: 10,),
