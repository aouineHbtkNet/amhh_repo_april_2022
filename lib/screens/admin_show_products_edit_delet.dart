          ...
          actions: [
            ...
            ElevatedButton(
                onPressed: () async {
                  ...
                  String message = await ProductUploadingAndDispalyingFunctions().deleteProduct(data);
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('${ product?.nombre_producto}', style: TextStyle(fontSize: sizedata, color: colorData, fontFamily: fontFamilydata),),
            ...
            Text('Contenido', style: TextStyle(fontSize: sizeTitle, color: colorTitle, fontFamily: fontFamilyTitle),),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                PopUpMenuWidgetAdmin(putArrow: true, callbackArrow: () {
                  Navigator.of(context).pop();
                },),

                Expanded(
                    child: productsAndCategories!=null   ? ListView.builder(
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      Container(
                                          ...
                                          child:
                                          product?.foto_producto != null ? Image.network(
                                            'http://192.168.1.22/api_v_1/storage/app/public/notes/${product?.foto_producto}', fit: BoxFit.fill,)
                                              ...
                                              IconButton(onPressed: () {
                                                Navigator.push(context,
                                                  MaterialPageRoute(builder:
                                                      (context)=>AdminEditProduct(
                                                        selectedproduct: productsAndCategories?.listOfProducts[index],
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                        border: Border.all(width: 2, color: Colors.blueGrey), borderRadius: BorderRadius.circular(8)
                                    ),
